...
void testLCD()
{
  switch(currentTest)
  {
    case NONE:
      ...
      LCD.setCursor(0,1); LCD.print(GetTestName(testChoice));
      break;
    case MOTORS:
      testMotorsLCD();
      break;
...
{
  LCD.print("LEFT:");
  LCD.setCursor(0,1);LCD.print((int)leftSpeed);
  LCD.setCursor(8,0);LCD.print("RIGHT:");
  LCD.setCursor(8,1);LCD.print((int)rightSpeed);
}

void testCollectorLCD()
{
  LCD.print("Collector:");
  LCD.setCursor(12,0);LCD.print(collectorAngle);
